...
namespace Opsive.BehaviorDesigner.Editor.Controls.Actions.GameObject
{
    ...
    using FindGameObjectByTagAction = Opsive.BehaviorDesigner.Runtime.Tasks.Actions.GameObjectTasks.FindGameObjectByTag;

    /// <summary>
    /// Implements TypeControlBase for the FindGameObjectByTag task.
    /// </summary>
    [ControlType(typeof(FindGameObjectByTagAction))]
    public class FindGameObjectByTagControl : ConditionalTypeControlBase<FindGameObjectByTagAction>
    {
        /// <summary>
        ...
        protected override VisualElement GetControl(TypeControlInput input, FindGameObjectByTagAction target)
        {
            ...
            ConditionalFieldControlUtility.AddWatchedField(input, target, "m_Tag", verticalLayout);
