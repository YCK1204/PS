...
namespace Opsive.BehaviorDesigner.Runtime.Tasks.Actions.Variables
{
    ...
    /// <summary>
    /// Gets the value of an int SharedVariable by name.
    /// </summary>
    [Opsive.Shared.Utility.Description("Gets the value of an int SharedVariable by name.")]
    [Shared.Utility.Category("Variables")]
    public class GetIntVariable : GetVariableBase
    {
        [Tooltip("The name of the int SharedVariable.")]
        [SerializeField] protected SharedVariable<string> m_VariableName;
        [Tooltip("The int variable to store the retrieved value.")]
        [RequireShared] [SerializeField] protected SharedVariable<int> m_Destination;
        ...
        public override TaskStatus OnUpdate()
        {
            var source = GetVariable<int>(m_VariableName);
            if (source != null) {
