...
namespace Water2D
{
    ...
    public partial class ModernWater2D : MonoBehaviour
    {
        ...
        void RebuildManagersWorkingRangesData()
        {
            ...
            foreach (var water in FindObjectsOfType<ModernWater2D>())
            {
                ...
                int sourceId = water.GetInstanceID();
            ...
            if (_obstructorManager != null || anyObstruction) obstructorManager.SyncLateAfterCamera(anyObstruction);
